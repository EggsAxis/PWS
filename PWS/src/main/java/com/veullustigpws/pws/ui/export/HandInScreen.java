...
public class HandInScreen extends JPanel {
	...
	private void initComponents() {
		...
		// Button
		JButton btn = new JButton("Terug naar begin");
	...
	public void setTimeOver(boolean timeOver) {
		if (timeOver) {
			label.setText("Tijd is op! Je werk is ingeleverd.");
		} else {
			label.setText("Je werk is ingeleverd.");
		}
	}
